...
>(({ className, ...props }, ref) => {
  ...
  return (
    <th
      ref={ref}
      className={cn(
        "whitespace-nowrap px-3 text-left align-middle text-xs font-semibold uppercase tracking-wide text-muted-foreground [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
        compact ? "h-9" : "h-11",
        className
      )}
      {...props}
